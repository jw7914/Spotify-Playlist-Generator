...
export default function TopTracksPage() {
  ...
  const handleCreatePlaylist = async () => {
    ...
    try {
      ...
      const playlistName = `Top Tracks - ${timeRangeLabel}  (${new Date().toLocaleDateString()})`;
      const description = `My top ${tracks.length} tracks from ${timeRangeLabel} as of ${new Date().toLocaleDateString()}. Generated by Spotify PlaylistGen.`;
